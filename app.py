...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Thị Quy - Trường Tiểu học Ngọc Đường - ĐT: 0823256001</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Thị Quy - Trường Tiểu học Ngọc Đường - ĐT: 0823256001</div>", unsafe_allow_html=True)
